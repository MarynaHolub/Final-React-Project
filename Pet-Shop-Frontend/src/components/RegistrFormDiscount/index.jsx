...
import styles from './RegistrFormDiscount.module.css';
...
function RegistrFormDiscount() {
  ...
  return (
    <div className={`${styles.container} ${styles.registrFormDiscount}`}>
...
export default RegistrFormDiscount;
